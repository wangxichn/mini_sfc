...
vnf_1.cmd(f"ifconfig {vnf_1_info['vnf_name']}-eth0 {vnf_1_info['vnf_ip']} netmask 255.255.255.0 up")
...
vnf_2.cmd(f"ifconfig {vnf_2_info['vnf_name']}-eth0 {vnf_2_info['vnf_ip']} netmask 255.255.255.0 up")
...
vnf_3.cmd(f"ifconfig {vnf_3_info['vnf_name']}-eth0 {vnf_3_info['vnf_ip']} netmask 255.255.255.0 up")
...
vnf_4.cmd(f"ifconfig {vnf_4_info['vnf_name']}-eth0 {vnf_4_info['vnf_ip']} netmask 255.255.255.0 up")
...
ue_1.cmd(f"ifconfig {ue_1_info['ue_name']}-eth0 {ue_1_info['ue_ip']} netmask 255.255.255.0 up")
...
ue_2.cmd(f"ifconfig {ue_2_info['ue_name']}-eth0 {ue_2_info['ue_ip']} netmask 255.255.255.0 up")
