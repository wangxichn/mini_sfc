...
class DrlFscpSolver(RadomSolver):
    ...
    def __learn(self,event: Event,solution:Solution):
    ...
    def solve_embedding(self, event: Event) -> Solution:
        ...
        subsolution, subbuffer, lastvalue = self.__learn(event,self.solution)
